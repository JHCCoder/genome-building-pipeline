# ============================================================================
# Genome-wide CENP-A signal + centroAnno HOR arrays
#
#   Blue bars:
...
CENTROANNO_HOR_BED <- paste0(
  "/tscc/projects/ps-renlab2/jhc103/degu-genome-assembly-proj/",
  "output/outputs-from-centraAnno/hifiasm-0414/cautils-chrOnly/HORs.bed"
)
...
# Use HOR midpoints as tick positions
hor_dt <- hor_raw[, .(
  chrom,
  start,
  end,
...
MAIN_TITLE <- "Genome-wide CENP-A signal and centroAnno HOR arrays"
...
OUTPUT_PDF <- file.path(
  FIGURE_DIR,
  "genome_wide_CENPA_centroAnno_HORs.pdf"
)

OUTPUT_SVG <- file.path(
  FIGURE_DIR,
  "genome_wide_CENPA_centroAnno_HORs.svg"
)
...
cat("\nDrawing genome-wide CENP-A + centroAnno HOR overview ...\n")
