...
read1="WB_438_R1_trimmed_combined.fq.gz" #"WB_438_2_S6_L003_R1_001.fastq.gz" #"WB_438_2_S1_L008_R1_001_val_1_subsampled.fq.gz" #"WB_438_R1_trimmed_combined.fq.gz"
read2="WB_438_R2_trimmed_combined.fq.gz" #"WB_438_2_S6_L003_R2_001.fastq.gz" #"WB_438_2_S1_L008_R2_001_val_2_subsampled.fq.gz" #"WB_438_R2_trimmed_combined.fq.gz"
run="403_ear_deep_file_combined"
data_dir="$HIC_HIFI_READ_DIR" #"$DATA_DIR/sequencing-reads-HiC" #"$HIC_HIFI_READ_DIR"
...
bwa-mem2 mem -A 1 -B 4 -E 50 -L 0 -t 8 "${genome_file}" "${data_dir}/${read1_base}_val_1.fq.gz" | samtools view -Shb - > "${output_dir}/${name1}_${genome}_1.bam"

echo "Aligning read 2..."
bwa-mem2 mem -A 1 -B 4 -E 50 -L 0 -t 8 "${genome_file}" "${data_dir}/${read2_base}_val_2.fq.gz" | samtools view -Shb - > "${output_dir}/${name1}_${genome}_2.bam"
